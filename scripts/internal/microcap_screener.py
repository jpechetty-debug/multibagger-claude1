...
def get_microcap_data(ticker_symbol):
    ...
    try:
        ...
        if peg_ratio is None:
            peg_ratio = 100  # Penalize if missing
...
def main():
    ...
    for symbol in TICKERS:
        ...
        if data:
            ...
            # Valuation check (skipped score for now)
            ...
            if is_microcap:
                ...
                if is_high_growth:
                    final_score += 1
                if data["Sales_Growth%"] > 20:
                    final_score += 1  # Extra point for super growth
                if data["Profit_Margin%"] > 12:
                    final_score += 1  # Quality margins
                if data["Pct_From_High"] > -20:
                    final_score += 1  # Technical Strength
