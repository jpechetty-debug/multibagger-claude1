    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-12 space-y-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/5 pb-12">
        ...
        <div className="flex gap-4">
          <div className="premium-glass-card p-6 rounded-2xl min-w-[160px]">
            <div className="text-[9px] text-brand-text-dim font-black uppercase tracking-widest mb-2">CAGR (PROJECTED)</div>
            <div className="text-3xl font-mono font-black text-brand-primary">+{performance.stats.cagr}%</div>
          </div>
          <div className="premium-glass-card p-6 rounded-2xl min-w-[160px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Core Metrics */}
        <div className="col-span-1 md:col-span-2 premium-glass-card rounded-3xl p-8 relative overflow-hidden group">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
             <div className="space-y-1">
               ...
               <div className="w-full h-1 bg-white/5 rounded-full mt-2">
                 <motion.div initial={{width: 0}} animate={{width: '62%'}} className="h-full bg-brand-primary" />
               </div>
             </div>
             <div className="space-y-1">
               ...
               <div className="w-full h-1 bg-white/5 rounded-full mt-2">
                 <motion.div initial={{width: 0}} animate={{width: '75%'}} className="h-full bg-brand-accent" />
               </div>
             </div>
             <div className="space-y-1">
        ...
        <div className="premium-glass-card rounded-3xl p-8">
          ...
          <div className="space-y-6">
            {[
              { label: 'Trend Strength', value: 85, color: 'text-brand-primary' },
              { label: 'Fundamental Base', value: 92, color: 'text-brand-emerald' },
              { label: 'Volatility Risk', value: 34, color: 'text-brand-rose' },
              { label: 'Liquidity Depth', value: 78, color: 'text-brand-accent' },
            ].map(item => (
      ...
      {/* System Alerts Strip */}
      <div className="bg-brand-primary/5 border border-brand-primary/20 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6">
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div>
            ...
            <div className="text-[9px] text-brand-primary font-bold uppercase tracking-widest">Active Alerts: 03</div>
          </div>
        </div>
        <div className="h-px md:h-8 w-full md:w-px bg-brand-primary/20" />
          ...
          <div className="flex gap-12 animate-[scroll_30s_linear_infinite] whitespace-nowrap">
            {[
              ...
              <span key={i} className="text-[10px] font-mono text-brand-text/80 font-medium">
                <span className="text-brand-primary mr-2">{" >>> "}</span> {alert}
              </span>
            ))}
          </div>
        </div>
