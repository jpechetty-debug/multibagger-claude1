...
model: inherit
skills: clean-code, nextjs-react-expert, web-design-guidelines, tailwind-patterns, frontend-design, lint-and-validate, ui-ux-pro-max, tdd-workflow, plan-writing, claude-mem
---
