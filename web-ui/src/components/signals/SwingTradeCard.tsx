...
import { TrendingUp, AlertTriangle, Crosshair, Activity, Clock, Star, ArrowRight } from 'lucide-react'
        ...
        <div className="col-span-1 md:col-span-5 flex flex-col">
          ...
          <div className="p-6 bg-brand-rose/[0.03] relative overflow-hidden group/sl flex items-center justify-between">
            ...
            <button 
              ...
              className="bg-brand-accent/10 hover:bg-brand-accent text-brand-accent hover:text-brand-bg border border-brand-accent/30 px-4 py-2 text-[10px] font-black uppercase tracking-widest transition-all rounded-lg flex items-center gap-2"
            >
