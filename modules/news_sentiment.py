...
class NewsSentimentEngine:
    ...
    def __init__(self):
        ...
        self._cache = {} # Simple in-memory cache for the session
    ...
    def get_alpha_signal(self, symbol: str) -> dict[str, Any]:
        ...
        if score > 0.4: alignment = "Breakout Bullish"
        elif score > 0.1: alignment = "Positive Drift"
        elif score < -0.4: alignment = "Toxic Drift"
        elif score < -0.1: alignment = "Negative Drift"
