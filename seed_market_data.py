...
async def process_ticker(symbol, semaphore):
    async with semaphore:
        try:
            ...
            if not data.get('Market_Cap_Cr') or not data.get('Sector') or data.get('Sector') == 'Unknown':
            ...
            if data['Score'] >= 92: data["Rating"] = "Strong Buy"
            elif data['Score'] >= 80: data["Rating"] = "Buy"
            elif data['Score'] >= 60: data["Rating"] = "Watch"
